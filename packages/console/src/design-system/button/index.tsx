...
export interface ButtonProps extends StyleXComponentProps<Omit<AriaButtonProps, "children">> {
...
export const Button = ({
  ...
  return (
    ...
    >
      {isPending && (
        <ProgressCircle isIndeterminate size="sm" style={styles.spinner} aria-label="Loading" />
      )}
      <span {...stylex.props(styles.content, isPending && styles.contentPending)}>{children}</span>
    </AriaButton>
  );
};
