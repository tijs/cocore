...
import { critical, primary, success, warning } from "../theme/semantic-color.stylex";
import {
  gap,
  horizontalSpace,
  size as sizeSpace,
  ...
  return (
    <div
      ...
      {...stylex.props(
        ...
        variant === "success" && [success.bgDim, success.borderDim, success.text],
        variant === "warning" && [warning.bgDim, warning.borderDim, warning.text],
        variant === "critical" && [critical.bgDim, critical.borderDim, critical.text],
        style,
      )}
      {...props}
    >
      {displayIcon != null && <div {...stylex.props(styles.icon)}>{displayIcon}</div>}
      <div {...stylex.props(styles.content, children != null && styles.contentWithDescription)}>
        {title != null && (
      ...
      {hasAction && <div {...stylex.props(styles.action, actionStyles)}>{action}</div>}
      {hasCloseButton && (
        <IconButton
          ...
          variant="tertiary"
          onPress={onDismiss}
          style={[actionStyles, styles.closeButton, hasAction && styles.actionAndClose]}
        >
          <X />
        </IconButton>
      )}
