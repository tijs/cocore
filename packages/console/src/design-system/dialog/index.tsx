...
export interface DialogHeaderProps extends StyleXComponentProps<React.ComponentProps<"div">> {}
...
export interface DialogDescriptionProps extends StyleXComponentProps<React.ComponentProps<"div">> {}

export const DialogDescription = ({ children, style }: DialogDescriptionProps) => {
  return <div {...stylex.props(typeramp.body, styles.description, style)}>{children}</div>;
};

export interface DialogBodyProps extends StyleXComponentProps<React.ComponentProps<"div">> {}

export const DialogBody = ({ children, style }: DialogBodyProps) => {
  return <div {...stylex.props(styles.body, style)}>{children}</div>;
};

export interface DialogFooterProps extends StyleXComponentProps<React.ComponentProps<"div">> {}
