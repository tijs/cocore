...
const styles = stylex.create({
  ...
  trackSingle: {
    height: {
      ":is([data-orientation=horizontal] *)": sizeSpace["xxs"],
      ":is([data-orientation=vertical] *)": "calc(attr(data-progress number) * 1%)",
    },
    width: {
      ":is([data-orientation=horizontal] *)": "calc(attr(data-progress number) * 1%)",
      ":is([data-orientation=vertical] *)": sizeSpace["xxs"],
    },
  },
  trackMultiple: {
    ...
    left: {
      ":is([data-orientation=horizontal] *)": "calc(attr(data-progress-start number) * 1%)",
      ":is([data-orientation=vertical] *)": "50%",
    },
    top: {
      ":is([data-orientation=horizontal] *)": "50%",
      ":is([data-orientation=vertical] *)": "calc(100% - attr(data-progress-end number) * 1%)",
    },
    width: {
          ...
          <>
            ...
            {state.values.length > 1 && (
              <div
                ...
                data-progress-end={state.getThumbPercent(state.values.length - 1) * 100}
