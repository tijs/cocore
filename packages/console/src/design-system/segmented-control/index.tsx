...
export interface SegmentedControlProps extends StyleXComponentProps<
  Omit<AriaToggleButtonGroupProps, "children" | "disallowEmptySelection" | "selectionMode">
> {
...
export const SegmentedControl = ({
  ...
  return (
    <AriaToggleButtonGroup
      ...
      {...props}
      {...stylex.props(styles.group, size === "sm" ? styles.small : styles.large, style)}
    >
      {children}
    </AriaToggleButtonGroup>
  );
...
export const SegmentedControlItem = ({ children, style, ...props }: SegmentedControlItemProps) => {
  return (
