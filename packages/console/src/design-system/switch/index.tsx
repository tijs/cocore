...
interface SwitchBaseProps extends StyleXComponentProps<Omit<AriaSwitchProps, "children">> {
...
export function Switch({
  ...
  return (
    <AriaSwitch {...props} onChange={handleChange} {...stylex.props(styles.wrapper, style)}>
      {children != null && labelVariant === "left" && (
        <div {...stylex.props(typeramp.label, styles.labelLeft)}>{children}</div>
      )}
