    ...
    <>
      ...
      */}
      ...
      <div {...stylex.props(inputStyles.wrapper)} onClick={() => inputRef.current?.focus()}>
        ...
        <DateInput {...stylex.props(inputStyles.input, styles.input)} ref={inputRef}>
...
export interface DateFieldProps<T extends DateValue> extends StyleXComponentProps<
  Omit<AriaDateFieldProps<T>, "isInvalid">
> {
  label?: React.ReactNode;
  description?: string;
  errorMessage?: string | ((validation: ValidationResult) => string);
