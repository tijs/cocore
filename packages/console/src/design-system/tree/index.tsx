...
function TreeItemContent({ children, prefix, suffix }: TreeItemContentProps) {
  ...
  return (
    <AriaTreeItemContent>
      {({ hasChildItems, selectionBehavior, selectionMode, allowsDragging, isSelected }) => (
        <div
          {...stylex.props(
        ...
        >
          {allowsDragging && (
            <div {...stylex.props(styles.dragButtonWrapper)}>
              <Button slot="drag" {...stylex.props(styles.dragButton, ui.border, ui.bgSubtle)}>
          ...
          <div {...stylex.props(styles.content)}>
            {prefix != null && (
              <div {...stylex.props(listBoxItemStyles.addon, styles.addon)}>{prefix}</div>
            )}
            <div {...stylex.props(listBoxItemStyles.label)}>{children}</div>
            {suffix != null && (
              <div {...stylex.props(listBoxItemStyles.addon, styles.addon)}>{suffix}</div>
            )}
          </div>
        </div>
      )}
...
type TreeItemProps<T extends object> = TreeItemTextProps<T> | TreeItemNodeProps<T>;
...
export function TreeItem<T extends object>({
  ...
  return (
    <AriaTreeItem
      ...
      {...stylex.props(listBoxItemStyles.wrapper, styles.wrapper, styles.itemInner, style)}
    >
