import type { AutocompleteProps as AriaAutocompleteProps, InputProps } from "react-aria-components";
import type { OverlayTriggerProps } from "react-stately";

import { useControlledState } from "@react-stately/utils";
import * as stylex from "@stylexjs/stylex";
import { useCallback, useEffect } from "react";
import { Autocomplete, Dialog, Menu, Modal, ModalOverlay, useFilter } from "react-aria-components";
...
export interface CommandMenuProps<T extends object>
  extends OverlayTriggerProps, Pick<InputProps, "placeholder">, AriaAutocompleteProps<T> {
...
export function CommandMenu<T extends object>({
  ...
  const [isOpen, setIsOpen] = useControlledState(isOpenProp, defaultOpen ?? false, onOpenChange);
