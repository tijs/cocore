 ...
 */
export interface FooterRootProps extends StyleXComponentProps<React.ComponentProps<"footer">> {
  /**
...
export const FooterRoot = ({ style, isCentered, ...props }: FooterRootProps) => {
  return (
    <footer
      {...props}
 ...
 */
export interface FooterLogoProps extends StyleXComponentProps<React.ComponentProps<"div">> {}
 ...
 */
export interface FooterSectionProps extends StyleXComponentProps<React.ComponentProps<"div">> {}

export const FooterSection = ({ style, children, ...props }: FooterSectionProps) => {
  return (
 ...
 */
export interface FooterNavSectionProps extends StyleXComponentProps<React.ComponentProps<"div">> {}

export const FooterNavSection = ({ style, ...props }: FooterNavSectionProps) => {
 ...
 */
export interface FooterNavGroupProps extends StyleXComponentProps<React.ComponentProps<"div">> {
  /**
...
export const FooterNavGroup = ({ style, title, children, ...props }: FooterNavGroupProps) => {
  return (
    <div {...props} {...stylex.props(styles.section, style)}>
      {title && <h3 {...stylex.props(styles.sectionTitle, ui.text)}>{title}</h3>}
 ...
 */
export interface FooterCopyrightProps extends StyleXComponentProps<React.ComponentProps<"p">> {}

export const FooterCopyright = ({ style, children, ...props }: FooterCopyrightProps) => {
  return (
...
export const FooterSocialLinkList = ({ style, children, ...props }: FooterSocialLinkListProps) => {
  return (
    <nav {...props} {...stylex.props(styles.socialLinkList, style)} aria-label="Social links">
      {children}
    </nav>
  );
};
 ...
 */
export interface FooterSubscribeProps extends StyleXComponentProps<React.ComponentProps<"div">> {
  /**
...
export const FooterSubscribe = ({
  ...
  return (
    <div {...props} data-subscribe-variant={variant} {...stylex.props(styles.subscribe, style)}>
      {children}
    </div>
  );
};
...
export const FooterSubscribeTitle = ({ style, children, ...props }: FooterSubscribeTitleProps) => {
  return (
...
export const FooterSubscribeDescription = ({
  ...
  return (
    <p {...props} {...stylex.props(styles.subscribeDescription, ui.textDim, style)}>
      {children}
    </p>
  );
};
