...
import { Separator as AriaSeparator, Toolbar as AriaToolbar, Group } from "react-aria-components";
...
export function Toolbar({ style, orientation = "horizontal", ...props }: ToolbarProps) {
  return (
    <AriaToolbar
      {...props}
