...
export const AlertDialog = ({
  ...
  return (
    <DialogTrigger defaultOpen={defaultOpen} isOpen={isOpen} onOpenChange={handleOpenChange}>
      ...
      <ModalOverlay isKeyboardDismissDisabled {...stylex.props(dialogStyles.overlay)}>
        <Modal {...stylex.props(dialogStyles.modal)}>
          <AriaDialog {...stylex.props(dialogStyles.dialog, styles.dialog)} role="alertdialog">
            {children}
          </AriaDialog>
        </Modal>
      </ModalOverlay>
...
export interface AlertDialogHeaderProps extends StyleXComponentProps<React.ComponentProps<"div">> {}

export const AlertDialogHeader = ({ children, style }: AlertDialogHeaderProps) => {
  return (
...
export interface AlertDialogFooterProps extends StyleXComponentProps<React.ComponentProps<"div">> {}

export const AlertDialogFooter = ({ children, style }: AlertDialogFooterProps) => {
