...
const styles = stylex.create({
  ...
  selectionIndicator: {
    ...
    borderBottomColor: {
      default: "transparent",
      ":is([data-orientation=horizontal] > [data-selected] > *)": primaryColor.solid1,
    },
    borderBottomStyle: {
      ":is([data-orientation=horizontal] *)": "solid",
      ":is([data-orientation=vertical])": "none",
    ...
    borderRightColor: {
      ":is([data-orientation=vertical] *)": "transparent",
      ":is([data-orientation=vertical] > [data-selected] > *)": primaryColor.solid1,
    },
    borderRightStyle: {
      ":is([data-orientation=horizontal] *)": "none",
      ":is([data-orientation=vertical] *)": "solid",
...
export interface TabsProps extends StyleXComponentProps<Omit<AriaTabsProps, "children">> {
...
export function Tabs({
  ...
  const handleSelectionChange = (key: Parameters<NonNullable<typeof onSelectionChange>>[0]) => {
    trigger("selection");
  ...
  return (
    <SizeContext value={size}>
      <AriaTabs
        ...
        data-size={size}
        {...stylex.props(styles.tabs, orientation === "vertical" && styles.tabsVertical, style)}
      >
        {children}
      </AriaTabs>
    </SizeContext>
...
export interface TabProps extends StyleXComponentProps<Omit<AriaTabProps, "children">> {
  children: React.ReactNode;
}
...
export interface TabPanelProps extends StyleXComponentProps<Omit<AriaTabPanelProps, "children">> {
  children: React.ReactNode;
}

export function TabPanel({ children, style, ...props }: TabPanelProps) {
  return (
    <AriaTabPanel {...props} {...stylex.props(styles.tabPanel, styles.focusRing, style)}>
      {children}
    </AriaTabPanel>
  );
}
