...
export function Label({ style, size: sizeProp, ...props }: LabelProps) {
  ...
  return <AriaLabel {...props} data-size={size} {...stylex.props(styles.label, style)} />;
}
...
export function Description({ style, size: sizeProp, ...props }: DescriptionProps) {
  if (!props.children) return null;
...
export function ErrorMessage({ style, size: sizeProp, ...props }: ErrorMessageProps) {
  const size = sizeProp || use(SizeContext);
...
export function FieldErrorMessage({ style, children, ...props }: FieldErrorMessageProps) {
  return (
