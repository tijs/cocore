 ...
 */
export interface HeaderLayoutRootProps extends StyleXComponentProps<React.ComponentProps<"div">> {
  maxWidth?: string;
}

export const HeaderLayoutRoot = ({ style, maxWidth, ...props }: HeaderLayoutRootProps) => {
  return (
    <div
      {...props}
...
export const HeaderLayoutHeader = ({ style, ...props }: HeaderLayoutHeaderProps) => {
 ...
 */
export interface HeaderLayoutPageProps extends StyleXComponentProps<React.ComponentProps<"main">> {}

export const HeaderLayoutPage = ({ style, ...props }: HeaderLayoutPageProps) => {
...
export const HeaderLayoutFooter = ({ style, ...props }: HeaderLayoutFooterProps) => {
...
export const HeaderLayoutHero = ({ style, children, ...props }: HeaderLayoutHeroProps) => {
  return (
