...
import { gap, horizontalSpace, verticalSpace } from "../theme/semantic-spacing.stylex";
import { fontFamily, fontSize, lineHeight, typeramp } from "../theme/typography.stylex";
...
export interface Heading1Props extends StyleXComponentProps<React.ComponentProps<"h1">> {}
...
export interface Heading2Props extends StyleXComponentProps<React.ComponentProps<"h2">> {}
...
export interface Heading3Props extends StyleXComponentProps<React.ComponentProps<"h3">> {}
...
export interface Heading4Props extends StyleXComponentProps<React.ComponentProps<"h4">> {}
...
export interface Heading5Props extends StyleXComponentProps<React.ComponentProps<"h5">> {}
...
export interface BodyProps extends StyleXComponentProps<React.ComponentProps<"p">> {
  variant?: TextVariant;
}
...
export const Body = ({ style, variant = "primary", ...props }: BodyProps) => {
  const contextValue = useMemo(
    () => ({
      style: [variant === "secondary" && ui.textDim, variant === "critical" && critical.textDim],
    }),
    [variant],
  );
...
export interface SmallBodyProps extends StyleXComponentProps<React.ComponentProps<"p">> {
  variant?: TextVariant;
}

export const SmallBody = ({ style, variant = "primary", ...props }: SmallBodyProps) => {
  const contextValue = useMemo(
    () => ({
      style: [
        variant === "secondary" && ui.textDim,
...
interface LabelTextProps extends StyleXComponentProps<React.ComponentProps<"p">> {
  variant?: TextVariant;
  hasEllipsis?: boolean;
}
...
interface SubLabelProps extends StyleXComponentProps<React.ComponentProps<"p">> {
  variant?: TextVariant;
}

export const SubLabel = ({ style, variant = "primary", ...props }: SubLabelProps) => {
  const contextValue = useMemo(
    () => ({
      style: [
        variant === "secondary" && ui.textDim,
...
export interface BlockquoteProps extends StyleXComponentProps<React.ComponentProps<"blockquote">> {}

export const Blockquote = ({ style, ...props }: BlockquoteProps) => {
  return <blockquote {...props} {...stylex.props(styles.blockquote, style)} />;
};

export interface UnorderedListProps extends StyleXComponentProps<React.ComponentProps<"ul">> {}

export const UnorderedList = ({ style, ...props }: UnorderedListProps) => {
  return <ul {...props} {...stylex.props(styles.unorderedList, style)} />;
};

export interface OrderedListProps extends StyleXComponentProps<React.ComponentProps<"ol">> {}

export const OrderedList = ({ style, ...props }: OrderedListProps) => {
  return <ol {...props} {...stylex.props(styles.orderedList, style)} />;
};

export interface ListItemProps extends StyleXComponentProps<React.ComponentProps<"li">> {}
...
export interface PreProps extends StyleXComponentProps<React.ComponentProps<"pre">> {}
...
export function Pre({ style, children, ...props }: PreProps) {
  ...
  return (
    <PreContext value={true}>
      <pre ref={ref} {...props} {...stylex.props(styles.pre, style)} data-testid="code">
        {children}
...
export interface InlineCodeProps extends StyleXComponentProps<React.ComponentProps<"code">> {}
...
export const InlineCode = ({ style, ...props }: InlineCodeProps) => {
  ...
  return <code {...props} {...stylex.props(styles.inlineCode, ui.bgSecondary, style)} />;
};
