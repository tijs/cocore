      ...
      <AriaColorPicker {...props} {...stylex.props(styles.root, style)}>
        <ColorSpaceProvider>
          <DialogTrigger>
            ...
            <Popover
              placement={placement}
              {...stylex.props(popoverStyles.wrapper, popoverStyles.animation, styles.popover)}
            >
...
export function DefaultColorEditor({
  ...
  return (
    <Flex direction="column" gap="xl" {...props} style={[styles.defaultPicker, style]}>
      {colorSpace === "hsb" ? (
        <ColorArea colorSpace={colorSpace} xChannel="saturation" yChannel="brightness" />
      ) : colorSpace === "hsl" ? (
        <ColorArea colorSpace={colorSpace} xChannel="hue" yChannel="saturation" />
      ) : (
      ...
      <Flex gap="md" align="center">
        ...
        <ColorField aria-label="HEX code" colorSpace={colorSpace} style={styles.grow} />
        {hasAlpha && (
          <ColorField
            aria-label="Alpha"
        ...
        <Flex direction="column" gap="xl" style={styles.controls}>
          {colorSpace === "hsb" ? (
            <>
              ...
              <ColorSlider label="Saturation" channel="saturation" colorSpace={colorSpace} />
              <ColorSlider label="Brightness" channel="brightness" colorSpace={colorSpace} />
            </>
          ) : colorSpace === "hsl" ? (
            <>
              <ColorSlider label="Hue" channel="hue" colorSpace={colorSpace} />
              <ColorSlider label="Saturation" channel="saturation" colorSpace={colorSpace} />
              <ColorSlider label="Lightness" channel="lightness" colorSpace={colorSpace} />
            </>
          ) : (
            <>
              <ColorSlider label="Red" channel="red" colorSpace={colorSpace} />
              <ColorSlider label="Green" channel="green" colorSpace={colorSpace} />
              <ColorSlider label="Blue" channel="blue" colorSpace={colorSpace} />
            </>
          )}

          {hasAlpha && <ColorSlider label="Alpha" channel="alpha" colorSpace={colorSpace} />}
        </Flex>
      </SizeContext>
      {swatches && (
        <>
