...
export function ProgressCircle({ label, style, size: sizeProp, ...props }: ProgressCircleProps) {
        ...
        return (
          <>
            <div {...stylex.props(styles.circleWrapper)}>
              <div {...stylex.props(styles.track, percentage === 100 && styles.completed)} />
              ...
              {isIndeterminate ? (
                <div {...stylex.props(styles.fills)}>
                  ...
                  >
                    <div {...stylex.props(styles.fillSubmask, styles.fillSubmaskIndeterminate)}>
