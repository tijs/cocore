...
export interface CheckboxProps extends StyleXComponentProps<Omit<AriaCheckboxProps, "children">> {
  children?: React.ReactNode;
}
    ...
    <AriaCheckbox {...props} {...stylex.props(styles.wrapper, style)}>
      {({ isIndeterminate, isSelected, isDisabled, isHovered }) => (
        <>
          ...
          >
            {isIndeterminate ? <Minus size={16} /> : isSelected ? <Check size={16} /> : null}
          </div>
          {children != null && (
