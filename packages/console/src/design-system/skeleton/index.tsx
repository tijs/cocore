...
export interface SkeletonGroupProps extends StyleXComponentProps<React.ComponentProps<"div">> {
  children: React.ReactNode;
}

export function SkeletonGroup({ children, style, ...props }: SkeletonGroupProps) {
  return (
...
interface SkeletonBaseProps extends StyleXComponentProps<React.ComponentProps<"div">> {}
...
export function Skeleton({ variant, size, height, width, style, ...props }: SkeletonProps) {
  if (variant === "circle") {
    return (
      <div
        {...props}
