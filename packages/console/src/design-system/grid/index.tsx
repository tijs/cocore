...
export interface GridProps extends StyleXComponentProps<React.ComponentProps<"div">> {
  /**
...
interface GridItemProps extends StyleXComponentProps<React.ComponentProps<"div">> {
  columnStart?: number;
  columnEnd?: number;
  rowStart?: number;
  rowEnd?: number;
