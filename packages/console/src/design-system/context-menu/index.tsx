...
import { Children, cloneElement, createContext, use, useCallback, useRef, useState } from "react";
...
function ContextMenuRoot({
  ...
  const { menuTriggerProps, menuProps } = useMenuTrigger({ ...props, type: "menu" }, state, ref);
...
export function ContextMenu<T extends object>({
  ...
  return (
    <SizeContext value={size}>
      <ContextMenuRoot defaultOpen={defaultOpen} isOpen={isOpen} onOpenChange={onOpenChange}>
        ...
        <Popover
          ...
          placement={placement}
          {...stylex.props(popoverStyles.wrapper, styles.menu, popoverStyles.animation, style)}
        >
          <AriaMenu {...props} />
        </Popover>
      </ContextMenuRoot>
