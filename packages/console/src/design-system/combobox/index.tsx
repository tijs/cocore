...
function ComboBoxContent<T extends object>({
  ...
  const content = (
    <>
      ...
      {description && <Description style={inputStyles.description}>{description}</Description>}
      {errorMessage && (
  ...
  return (
    <>
      ...
      <Popover
        ...
        placement={placement}
        {...stylex.props(popoverStyles.wrapper, popoverStyles.animation, styles.matchWidth)}
      >
        {listbox}
      </Popover>
    </>
