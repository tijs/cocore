...
export type IconButtonProps = IconButtonWithLabelProps | IconButtonWithAriaLabelProps;
...
export const IconButton = ({
  ...
  return (
    <Tooltip text={label} isOpen={tooltipOpen} onOpenChange={onTooltipOpenChange}>
      <Button
        size={size}
        style={[styles.button as unknown as stylex.StyleXStyles, style]}
        {...props}
