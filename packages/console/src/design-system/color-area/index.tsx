...
import { ColorArea as AriaColorArea, ColorThumb as AriaColorThumb } from "react-aria-components";
...
export interface ColorAreaProps extends StyleXComponentProps<Omit<AriaColorAreaProps, "children">> {
  children?: React.ReactNode;
  aspectRatio?: number;
}

export function ColorArea({ style, aspectRatio = 1, ...props }: ColorAreaProps) {
  return (
    <AriaColorArea
      {...props}
      {...stylex.props(styles.colorArea, style, styles.aspectRatio(aspectRatio))}
    >
      <ColorThumb />
    </AriaColorArea>
  );
