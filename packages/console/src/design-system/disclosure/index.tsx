...
export function Disclosure({ children, style, size: sizeProp, ...props }: DisclosureProps) {
  const size = sizeProp || use(SizeContext);

  return (
    <AriaDisclosure {...props} data-size={size} {...stylex.props(styles.disclosure, style)}>
      {children}
    </AriaDisclosure>
  );
}
...
export function DisclosureTitle({ children, style, ...props }: DisclosureTitleProps) {
  return (
    <Button
      {...props}
      slot="trigger"
      {...stylex.props(styles.title, props.isDisabled && styles.titleDisabled, style)}
    >
      {children}
...
export function DisclosurePanel({ children, style, ...props }: DisclosurePanelProps) {
  return (
