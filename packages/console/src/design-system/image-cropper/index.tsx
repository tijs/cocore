...
export interface ImageCropperRootProps extends StyleXComponentProps<
  Omit<
    ...
    "className" | "style" | "children" | "onCropChange" | "image" | "aspectRatio"
  >
> {
  /**
...
export function ImageCropperRoot({
  ...
  const createImageUrl = useEffectEvent(() => {
    ...
    const newUrl = typeof image === "string" ? image : URL.createObjectURL(image);
  ...
  if (aspectRatio !== null && aspectRatio !== undefined) {
    (cropperProps as typeof cropperProps & { aspectRatio: number }).aspectRatio = aspectRatio;
  }
...
export function ImageCropperImage({ style, ...props }: ImageCropperImageProps) {
  return <OriginCropper.Image {...props} {...stylex.props(styles.image, style)} />;
}
 ...
 * ```
 */
export function ImageCropperCropArea({ style, ...props }: ImageCropperCropAreaProps) {
  return <OriginCropper.CropArea {...props} {...stylex.props(styles.cropArea, style)} />;
}
...
export function ImageCropperDescription({
  ...
  return (
    <OriginCropper.Description {...props} {...stylex.props(styles.description, style)}>
      {children}
