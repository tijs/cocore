...
import type { PanelGroupProps, PanelProps, PanelResizerProps } from "@window-splitter/react";
...
export function PanelResizer({ style, ...props }: WindowSplitterPanelResizerProps) {
