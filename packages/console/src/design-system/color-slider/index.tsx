...
export function ColorSlider({
  ...
  return (
    <SizeContext value={size}>
      <AriaColorSlider {...props} data-size={size} {...stylex.props(styles.colorSlider, style)}>
        {label && <Label style={styles.label}>{label}</Label>}
        {showValueLabel && <SliderOutput data-slider-output {...stylex.props(styles.valueLabel)} />}
        <SliderTrack
