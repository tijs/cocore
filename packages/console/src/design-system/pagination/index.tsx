...
export interface PaginationProps extends StyleXComponentProps<React.ComponentProps<"div">> {
...
function sliceRange(center: number, totalPages: number, maxVisiblePages: number) {
