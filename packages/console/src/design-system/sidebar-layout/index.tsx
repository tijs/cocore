 ...
 */
export interface SidebarLayoutRootProps extends StyleXComponentProps<React.ComponentProps<"div">> {}

export const SidebarLayoutRoot = ({ style, children, ...props }: SidebarLayoutRootProps) => {
  return (
    <div {...props} {...stylex.props(styles.wrapper, style)} data-sidebar-layout={true}>
...
export const SidebarLayoutPage = ({ style, ...props }: SidebarLayoutPageProps) => {
