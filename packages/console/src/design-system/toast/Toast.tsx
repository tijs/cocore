...
import type { ToastRegionProps as AriaToastRegionProps, QueuedToast } from "react-aria-components";
...
import { criticalColor, successColor, uiColor, warningColor } from "../theme/color.stylex";
import {
  gap,
  horizontalSpace,
  size as sizeSpace,
    ...
    >
      ...
      <ToastContent {...stylex.props(styles.content)}>
        ...
        {toast.content.description && (
          <Text slot="description" {...stylex.props(styles.description, typeramp.label)}>
            {toast.content.description}
          </Text>
        )}
      </ToastContent>
      <Flex direction="row" gap="xs">
        ...
        <IconButton aria-label="Close" size="sm" variant="tertiary" slot="close">
          <X />
        </IconButton>
      </Flex>
    </Toast>
...
export function ToastRegion({ style, ...props }: ToastRegionProps) {
  return (
    <AriaToastRegion queue={toasts} {...props} {...stylex.props(styles.region, style)}>
