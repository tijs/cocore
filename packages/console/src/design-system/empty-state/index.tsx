...
import { gap, horizontalSpace, size as sizeSpace } from "../theme/semantic-spacing.stylex";
...
export interface EmptyStateProps extends StyleXComponentProps<React.ComponentProps<"div">> {
  /**
...
export const EmptyState = ({ style, size: sizeProp, ...props }: EmptyStateProps) => {
  const size = sizeProp || use(SizeContext);

  return (
    <div {...props} data-empty-state-size={size} {...stylex.props(styles.emptyState, style)} />
  );
};
...
export const EmptyStateImage = ({ style, src, alt, children, ...props }: EmptyStateImageProps) => {
  if (src) {
...
export interface EmptyStateTitleProps extends StyleXComponentProps<React.ComponentProps<"div">> {}
...
export const EmptyStateDescription = ({ style, ...props }: EmptyStateDescriptionProps) => {
  return <p {...props} {...stylex.props(styles.description, ui.textDim, style)} />;
};

export interface EmptyStateActionsProps extends StyleXComponentProps<React.ComponentProps<"div">> {}

export const EmptyStateActions = ({ style, ...props }: EmptyStateActionsProps) => {
  return <div {...props} data-empty-state-actions {...stylex.props(styles.actions, style)} />;
};
