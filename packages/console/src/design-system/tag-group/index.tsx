...
import { Tag as AriaTag, TagGroup as AriaTagGroup, Button, TagList } from "react-aria-components";
...
export function TagGroup<T extends object>({
  ...
  return (
    <AriaTagGroup {...props} {...stylex.props(styles.group, style)}>
      ...
      <TagList items={items} renderEmptyState={renderEmptyState} {...stylex.props(styles.list)}>
        {children}
      </TagList>
...
export interface TagProps extends StyleXComponentProps<Omit<AriaTagProps, "children">> {
...
export function Tag({ children, style, ...props }: TagProps) {
  ...
  return (
    <AriaTag textValue={textValue} {...props} {...stylex.props(styles.tag, typeramp.label, style)}>
      {({ allowsRemoving }) => (
        <>
