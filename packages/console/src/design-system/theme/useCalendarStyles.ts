...
const styles = stylex.create({
  ...
  nonRangeCell: {
    ...
    backgroundColor: {
      ...
      ":is([data-hovered]):not(:is([data-unavailable]))::before": uiColor.component2,
      ":is([data-pressed]):not(:is([data-unavailable]))::before": uiColor.component3,
      ":is([data-selected]):not(:is([data-unavailable]))::before": primaryColor.component2,
  ...
  rangeCell: {
    backgroundColor: {
      ":is(*)::before": "transparent",
      ":is([data-hovered]):not(:is([data-unavailable]))::before": uiColor.component3,
      ":is([data-pressed]):not(:is([data-unavailable]))::before": uiColor.border1,
...
export function useCalendarStyles({ type }: { type: "calendar" | "range-calendar" }) {
  return {
    wrapper: [styles.wrapper],
    grid: [styles.grid],
    heading: [styles.heading],
    headerCell: [styles.headerCell],
    cell: [styles.cell, type === "range-calendar" ? styles.rangeCell : styles.nonRangeCell],
  };
}
