...
import type { InputValidationState, InputVariant, LabelVariant, Size } from "../theme/types";

import { SizeContext } from "../context";
import { animationDuration } from "./animations.stylex";
import { criticalColor, successColor, uiColor, warningColor } from "./color.stylex";
import { radius } from "./radius.stylex";
import { ui } from "./semantic-color.stylex";
import { gap, horizontalSpace, size as sizeSpace } from "./semantic-spacing.stylex";
...
export function useInputStyles({
  ...
  return {
    field: [styles.field, labelVariant === "horizontal" && styles.horizontalLabel],
    wrapper: [
      styles.inputWrapper,
      ui.text,
      variant === "primary" && [
