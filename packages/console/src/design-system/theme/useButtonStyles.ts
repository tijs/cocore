...
export const useButtonStyles = ({
  ...
  return [
    group?.orientation === "horizontal" && group.variant === "grouped" && styles.groupHorizontal,
    group?.orientation === "vertical" && group.variant === "grouped" && styles.groupVertical,
    variant === "primary" && [
      primary.bgAction,
    ...
    variant === "outline" && [ui.borderInteractive, ui.bgGhost, ui.text, styles.shadow],
    variant === "critical" && [
