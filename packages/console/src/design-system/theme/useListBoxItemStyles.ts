...
import { fontSize, fontWeight, lineHeight, typeramp } from "../theme/typography.stylex";
...
const styles = stylex.create({
  item: {
    ...
    fontWeight: {
      ...
      [":is([data-react-aria-pressable=true][data-selected=true])"]: fontWeight["medium"],
    },
  ...
  itemInner: {
    ...
    color: {
      ...
      [":is([data-react-aria-pressable=true][data-disabled] *)"]: uiColor.border3,
    },
    display: "flex",
    flexGrow: 1,
