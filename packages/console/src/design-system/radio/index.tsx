...
interface RadioGroupProps extends StyleXComponentProps<Omit<AriaRadioGroupProps, "children">> {
...
export interface RadioProps extends StyleXComponentProps<Omit<AriaRadioProps, "children">> {
  children?: React.ReactNode;
}
