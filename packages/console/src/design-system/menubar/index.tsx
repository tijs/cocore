...
export interface MenubarProps extends StyleXComponentProps<React.ComponentProps<"div">> {
  size?: Size;
  value?: string;
  defaultValue?: string;
...
export interface MenubarItemProps
  extends StyleXComponentProps<React.ComponentProps<"div">>, Pick<ButtonProps, "isDisabled"> {
  label: string;
}
    ...
    >
      <Flex direction="column" style={[styles.item, style]} {...props}>
        ...
        >
          ...
          <div
            onKeyDown={(e) => {
              if (["ArrowRight", "ArrowLeft"].includes(e.key) && !e.defaultPrevented) {
                e.preventDefault();
